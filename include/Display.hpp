...
class Display_obj
{
    ...
    public:
        Display_obj(mInt cX, mInt cY, uint16_t cColor, TFT_ILI9163C& Display); //Construtor do objeto
...
class Circle : public Display_obj
{
    ...
    public:
       Circle (mInt cx, mInt cy, mInt cr, uint16_t cColor, TFT_ILI9163C &Display_); //Construtor da classe
...
class Triangle : public Display_obj
{
    ...
    public:
        ...
        Triangle(mInt cx, mInt cy, uint16_t cColor, TFT_ILI9163C &Display_); //construtor da classe
...
class Heart : public Display_obj
{
    ...
    public:
        Heart(mInt cx, mInt cy, uint16_t cColor, TFT_ILI9163C &Display_); //Construtor da classe
